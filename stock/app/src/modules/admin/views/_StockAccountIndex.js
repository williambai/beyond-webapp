...
var Account = require('../models/StockAccount');
var ListView = require('./_StockAccountList');
...
exports = module.exports = Backbone.View.extend({
	...
	addAccount: function(evt){
		this.router.navigate('stock/account/add',{trigger: true});
		return false;
	},
	...
	editAccount: function(evt){
		var $item = this.$(evt.currentTarget).parent().parent();
		var id = $item.attr('id');
		this.router.navigate('stock/account/edit/'+ id,{trigger: true});
		return false;
	},
