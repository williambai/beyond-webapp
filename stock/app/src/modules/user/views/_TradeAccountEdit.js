...
var FormView = require('./__FormView'),
	...
	TradeAccount = require('../models/TradeAccount');
...
exports = module.exports = FormView.extend({
	...
	initialize: function(options) {
		...
		this.model = new TradeAccount({_id: options.id});
		var page = $(accountTpl);
	...
	cancel: function(){
		this.router.navigate('trade/account/index',{trigger: true, replace: true});
		return false;
	},
	...
	render: function(){
		...
		if(company){
			this.$('input[name="company['+ company.name +']"]').attr('checked', true);
		}
		return this;
	},
});