...
var Page = require('../models/PageStatic');
var ListView = require('./_PageStaticList');
var SearchView = require('./_PageStaticSearch');
...
exports = module.exports = Backbone.View.extend({
	...
	addPage: function(){
		this.router.navigate('page/static/add',{trigger: true});
		return false;
	},

	editPage: function(evt){
		var id = this.$(evt.currentTarget).closest('.item').attr('id');
		this.router.navigate('page/static/edit/'+ id,{trigger: true});
		return false;
	},
