...
for (var n in AttrCfg) {
	...
	attrs[n] = {name: n,type: attr[0],len: parseInt(attr[1])};
	// attrs[n] = new Attr(n, attr[0], attr[1]);
}

exports = module.exports = attrs;

// unit test
if (process.argv[1] === __filename) {
	console.log(exports);
	console.log(exports.UserName); //Attr{}
	console.log(typeof exports.UserName); //object
	console.log(exports.UserName.name); //'UserName'
	console.log(exports.UserName.Attr); //undefined
}