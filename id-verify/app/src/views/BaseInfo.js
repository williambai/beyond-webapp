var $ = require('jquery'),
    ...
    baseInfoTemplate = require('../../assets/templates/baseInfo.tpl'),
...
exports = module.exports = Backbone.View.extend({
	...
	load: function(){
		var that = this;
		$.ajax(config.api.host + '/persons/times?type=base', {
			method: 'GET',
	...
	baseInfo: function(){
		...
		$.ajax(config.api.host + '/persons/check?type=base', {
			method: 'POST',
			dataType: 'json',
			data: {
				persons: {
	...
	render: function(){
		this.$el.html(baseInfoTemplate({limits:this.limits,person: this.model.toJSON()}));
