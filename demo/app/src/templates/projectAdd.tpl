<p>一个具体工作，一个代办事宜，一个工作话题都可以成为一个项目。只要需要通过一个团队协作，达成一个目标都可以按照项目创建。</p>
<p>一旦您创建了一个项目，您就是这个项目的主持人，具有比其他成员更高级的管理权限。</p>
...
<form >
	...
	<div class="form-group" id="description">
		<label>项目描述(300字以内)：</label>
		<textarea name="description" rows="5" placeholder="项目目的，范围，用户等信息" class="form-control"/>
		<span class="help-block"></span>
	</div>
