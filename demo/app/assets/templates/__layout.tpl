<div class="sidebar sidebar-left">
	<div class="scrollable" style="padding-top:70px;">
		<div class="scrollable-header app-name">
			<a href="#" onclick="window.location.reload();return false;">我的工作社交网</a>&nbsp;<a href="#project/add" class="pull-right">
			<i class="fa fa-plus-square"></i>项目</a>
		</div>
		<div class="scrollable-content">
			<div class="list-group">
				<a class="list-group-item active" href="#index"><i class="fa fa-users fa-fw"></i>&nbsp;首页<span class="status-unread pull-right"><i class="fa fa-chevron-right"></i></span></a>
				<a class="list-group-item" href="#project/me"><i class="fa fa-home fa-fw"></i>&nbsp;我的项目<i class="fa fa-chevron-right pull-right"></i></a>
				<a class="list-group-item" href="#activity/me"><i class="fa fa-users fa-fw"></i>&nbsp;同事圈<span class="status-unread pull-right"><i class="fa fa-chevron-right"></i></span></a>
				...
				<a class="list-group-item" href="#space/me"><i class="fa fa-home fa-fw"></i>&nbsp;我的发表<i class="fa fa-chevron-right pull-right"></i></a>
				<a class="list-group-item" href="#notify/me"><i class="fa fa-meh-o fa-fw"></i>&nbsp;通知提醒<i class="fa fa-chevron-right pull-right"></i></a>
