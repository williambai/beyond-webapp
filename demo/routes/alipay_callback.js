exports = module.exports = function(app,models){
	var alipay = require('../libs/alipay_api');
	...
	app.use('/create_direct_pay_by_user',function(req, res){
	...
	app.use('/refund_fastpay_by_platform_pwd', function(req, res){
		if(req.route.method == 'get'){
	...
	app.use('/create_partner_trade_by_buyer', function(req, res){
		if(req.route.method == 'get'){
	...
	app.use('/send_goods_confirm_by_platform', function(req, res){
		if(req.route.method == 'get'){
	...
	app.use('/create_direct_bankpay_by_user', function(req, res){
		if(req.route.method == 'get'){
	...
	app.use('/trade_create_by_buyer', function(req, res){
		if(req.route.method == 'get'){
