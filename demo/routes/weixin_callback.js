exports = module.exports = function(app,models){
	...
	var oauthRequest = function(req,res){
			var originid = config.mp.originid;//req.query.originid;
			if(!originid){
				res.sendStatus(400);
				return;	
  ...
  */
 	//check openid
 	app.use('/wechat/check/openid', checkOpenid);
 	//oauth2
 	app.use('/wechat/oauth2', oauthRequest);
 	//authorized
 	app.use('/wechat/authorized', authorized);
 	//mp
 	app.use('/wechat', mpMiddleware, mp);
 	//corp 
 	app.use('/corp', qyMiddleware, corp);
 	//update project
 	app.use('/wechat/project/update', updateProject);
};